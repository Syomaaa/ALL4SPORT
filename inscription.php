    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form method="POST" onsubmit="return validateEmail()" action="traitementinscription.php" class="sign-in-form">
            ...
            <input href="accueil.html" type="submit" name="forminscription" value="inscription" class="btn solid" />  
          </form>
        </div>
      </div>
